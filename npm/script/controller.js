...
function Controller(args) {
    return function (target) {
        Reflect.defineMetadata(exports.CONTROLLER_NAME, args.name, target);
    };
}
/**
...
function GetPromise() {
    return function (target, propertyKey, _descriptor) {
        ...
        const existing = Reflect.getMetadata(exports.CONTROLLER_METHOD_TYPES, ctor) || {};
        existing[propertyKey] = 'promise';
        Reflect.defineMetadata(exports.CONTROLLER_METHOD_TYPES, existing, ctor);
    };
}
/**
