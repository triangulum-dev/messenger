...
class AppBuilder {
    ...
    build() {
        ...
        const appContext = new app_context_js_1.AppContext(this.target);
        return new app_reference_js_1.AppReference(appContext, __classPrivateFieldGet(this, _AppBuilder_promiseHandlers, "f"), __classPrivateFieldGet(this, _AppBuilder_observableHandlers, "f"));
    }
}
